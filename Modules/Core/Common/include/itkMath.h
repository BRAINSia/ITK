...
{
  static const bool T1IsComplex = itk::NumericTraits< T1 >::IsComplex;
  static const bool T2IsComplex = itk::NumericTraits< T2 >::IsComplex;
 ...
 *     seperate values into real and imaginary components and compare them seperately
 *
