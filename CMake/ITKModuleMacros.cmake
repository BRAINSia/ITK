...
macro(itk_module _name)
  ...
  set(ITK_MODULE_${itk-module}_LINK_DEPENDS "")
  set(ITK_MODULE_${itk-module}_LINK_DEPENDS_EXPLICIT "")
...
if("${arg}" MATCHES "^((|EXPLICIT_|LINK_|USE_|)DEPENDS|TEST_DEPENDS|DESCRIPTION|DEFAULT)$")
    ...
    elseif("${_doing}" MATCHES "^LINK_DEPENDS$")
      list(APPEND ITK_MODULE_${itk-module}_LINK_DEPENDS_EXPLICIT "${arg}")
    elseif("${_doing}" MATCHES "^USE_DEPENDS$")
      list(APPEND ITK_MODULE_${itk-module}_DEPENDS "${arg}")
  ...
  list(SORT ITK_MODULE_${itk-module}_LINK_DEPENDS) # Deterministic order.
  list(SORT ITK_MODULE_${itk-module}_LINK_DEPENDS_EXPLICIT) # Deterministic order.
